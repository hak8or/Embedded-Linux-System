...
Please check out the [git repository](https://github.com/hak8or/Embedded-Linux-System) version of this which will show you all the extra files used to make this happen, for example ```.txt``` based docs meant for myself and schematics and gerbers.
